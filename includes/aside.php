    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview" id="transMainNav">
        ...
        <ul class="treeview-menu">
          <li id="transSalesSubNav"><a href="pos.php">POS</a></li>
          <li id="transOrdersSubNav"><a href="order.php">Orders</a></li>
      ...
      <!-- <li class="treeview" id="masterMainNav">
        ...
        <ul class="treeview-menu">
          <li id="reportsSalesSubNav"><a href="sales_report.php">Sales</a></li>
        </ul>
      </li> -->
